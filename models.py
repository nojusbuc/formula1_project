...
class Session(db.Model):
    ...
    many_cars = db.Column(db.Boolean)
    active_cars = db.Column(db.Integer)
    players = db.relationship('Player', backref='session')


class Player(db.Model):  # points to Session
    
    player_id = db.Column(db.Integer, primary_key=True) #player_car_index
...
class LapData(db.Model):  # points to Car class
    ...
    car_position = db.Column(db.Integer)
...
class Streaming(db.Model):
    ...
    should_run = db.Column(db.Integer)
